...
namespace NorthbridgeSubSystem
{
    public partial class BaseForm : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //Checks if the files set in the CommonVariables.cs are present. Adjust this accordingly.
            if (!File.Exists(CommonVariables.PlayerFile) || !File.Exists(CommonVariables.RgssLib) || !File.Exists(CommonVariables.GameFile))
            {
                MessageBox.Show(@"Missing file(s). Aborting.", @"Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Close();
            }
            else
            {
                ...
                // Set these with GameInfo.Arguments = "argument1 argument2";
                ...
                if (Settings.Default.AutoBackupEnabled && Settings.Default.AutoBackupLocation != null && CommonVariables.CountChanges > 0 && !Settings.Default.SingleBackupMode) BackupEngine.AutoBackupCode();
                Close();
            }
